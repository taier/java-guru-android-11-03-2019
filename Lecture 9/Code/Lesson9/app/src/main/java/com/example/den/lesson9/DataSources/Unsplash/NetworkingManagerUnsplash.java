package com.example.den.lesson9.DataSources.Unsplash;
...
public class NetworkingManagerUnsplash implements NetworkingManager {
    ...
    public void getPhotoItems(NetworkingResultListener result) {
        ...
        Request request = new Request.Builder()
                .url("https://api.unsplash.com/photos/?page=1&per_page=30&client_id=311ed690d7678d20b8ce556e56d5bf168d6ddf9fa1126e58193d95089d796542")
                .build();
